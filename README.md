# TodoApp M295
## Überbetrieblicher Kurs (In24a)  - Mike Sandor Zaugg

---

## Planung

> - 0.5h Setup/config (.env, dependencies, resources, swagger)
> - 1h Datenbankanbindung (TypeORM, Entity, Dummy Daten)
> - 2h Sicherheit (User -> Auth Modules, Guards Authentifizierung, JWT, PW hash)
> - 2h CRUD Operationen / Rollen validierung / Statuscodes / Swagger Decorators
> - 1h DTO's erstellt / Middleware / Interceptor
> - 1h Testing (Postman) -> 100% Coverage 
